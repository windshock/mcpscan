...
pip install https://github.com/windshock/mcpscan/releases/download/v0.2.1/mcp_guard-0.2.1-py3-none-any.whl

# With cisco supply-chain detection
pip install 'https://github.com/windshock/mcpscan/releases/download/v0.2.1/mcp_guard-0.2.1-py3-none-any.whl[cisco]'
```
